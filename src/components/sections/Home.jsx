            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-neutral-300 text-lg mb-8 max-w-lg mx-auto leading-relaxed">
                        CS student building systems software in C++ and Python. Currently
                        developing an LLM-powered query interface that bridges natural
                    ...
                    <div className="flex justify-center flex-wrap gap-4">
                        ...
                        {/* Add your CV PDF to /public/resume.pdf and remove this comment */}
                        <a
                            href="/resume.pdf"
                            download
