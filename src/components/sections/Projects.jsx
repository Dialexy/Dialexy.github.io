        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              <div
                key={index}
                className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white hover:shadow-[0_2_8_rgba(255,255,255,0.2)] transition"
              >
                ...
                <div className="flex flex-wrap gap-3 mb-7">
                  {project.techStack.map((tech, idx) => (
                    <span
                      key={idx}
                      className="bg-stone-500 text-gray-300 py-1 px-3 rounded-full text-sm hover:bg-stone-500/30 hover:shadow-[0_2_8_rgba(255,255,255,0.2)] transition-all"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex justify-between items-center my-4">
                  <a
                    href={project.link}
                    className="text-white hover:text-stone-500 transition-colors"
                  >
                    View Project →
                  </a>
                </div>
