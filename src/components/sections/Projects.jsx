...
export const Projects = () => {
  const projects = [
    {
      ...
      description:
        'Self-balancing binary search tree in C++ with automatic rebalancing through rotations. Features complete memory management, O(log n) operations, and easy integration into larger projects.',
...

    {
      ...
      description:
        'A lightweight, thread-safe task scheduling system designed to manage and execute tasks in memory. Features priority-based execution, expiration handling, and runtime metrics. Built with modular components (task registry, scheduling queue, and observability layer), ensuring immutability, thread safety, and efficient task lifecycle management.',
  ...
  return (
    <section id="projects" className="min-h-screen flex items-center justify-center py-20 pb-0">
      <RevealOnScroll>
